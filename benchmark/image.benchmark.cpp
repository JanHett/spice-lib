...
//     for (auto _ : state) {
//         // auto img = spice::load_image<float, 3>("../data/testing/boat.jpg");
...
//     for (auto _ : state) {
//         // auto img = spice::load_image_separate<float, 3>("../data/testing/boat.jpg");
//         std::vector<T> img_data_planar(spec.width * spec.height * spec.nchannels);
...
auto file_c1 = OIIO::ImageInput::open("../data/testing/eibsee.tif");
